"""
Driver Arrival Rate Sensitivity Analysis: LIFO Dispatching
===============================================================

This script analyzes system performance under LIFO dispatching across
...
def main():
    ...
    print("="*80)
    print("LIFO DISPATCHING: DRIVER ARRIVAL RATE SENSITIVITY ANALYSIS")
    print("="*80)
    ...
    for driver_arrival_rate in range(arrival_rate_min, arrival_rate_max + 1):
        ...
        try:
            ...
            setting = Setting(
                ...
                reneging=reneging,
                initial_alpha='1'  # Random initial acceptance strategy
            )
            ...
            filename = save_run_history(
                ...
                outcome_list,
                simulator.version,
                setting.dispatching_rule, directory='completed_runs/lifo'
            )
    ...
    print(f"Algorithm: {algorithm}")
    print(f"Results directory: ./completed_runs/lifo")
