"""
Driver Arrival Rate Sensitivity Analysis: DYNAMIC RANDOMIZED FIFO Dispatching
===============================================================
...
def main():
    ...
    print("="*80)
    print("DYNAMIC RANDOMIZED FIFO DISPATCHING: DRIVER ARRIVAL RATE SENSITIVITY ANALYSIS")
    print("="*80)
    ...
    dispatching_rule = "DYNAMIC_RAND_FIFO"         # Dynamic randomized FIFO job assignment
    ...
    for driver_arrival_rate in range(arrival_rate_min, arrival_rate_max + 1):
        ...
        try:
            ...
            setting.gamma_cnst_grad = 1000           # Gradient phase step size
            ...
            filename = save_run_history(
                ...
                directory = r'completed_runs/dynamic_rand_fifo'
            )
    ...
    print(f"Algorithm: {algorithm}")
    print(f"Results directory: ./completed_runs/dynamic_rand_fifo/")
