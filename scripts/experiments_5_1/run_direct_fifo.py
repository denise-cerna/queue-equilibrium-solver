"""
Driver Arrival Rate Sensitivity Analysis: DIRECT FIFO Dispatching
===============================================================

This script analyzes system performance under direct FIFO dispatching across
...
def main():
    ...
    print("="*80)
    print("DIRECT FIFO DISPATCHING: DRIVER ARRIVAL RATE SENSITIVITY ANALYSIS")
    print("="*80)
    ...
    dispatch_rule = "DIRECT_FIFO"         # Direct FIFO job assignment
    ...
    for driver_arrival_rate in range(arrival_rate_min, arrival_rate_max + 1):
        ...
        try:
            ...
            filename = save_run_history(
                ...
                outcome_list,
                simulator.version,
                setting.dispatching_rule, directory = r'completed_runs/direct_fifo'
            )
    ...
    print(f"\nDispatch rule: {dispatch_rule}")
    print(f"Algorithm: {algorithm}")
    print(f"Results directory: ./completed_runs/direct_fifo/")
