"""
Driver Arrival Rate Sensitivity Analysis: PURE_RAND Dispatching
===============================================================

This script analyzes system performance under pure random dispatching across
a range of driver arrival rates. The experiment sweeps λ from 1 to 15 to
identify critical load thresholds and equilibrium behavior transitions.
...
# WARNING: The following experiments require 53GB of peak memory 
def main():
    """
    ...
    print("="*80)
    print("PURE RANDOM DISPATCHING: DRIVER ARRIVAL RATE SENSITIVITY ANALYSIS")
    print("="*80)
    ...
    dispatching_rule = "PURE_RAND"         # Pure random job assignment
    ...
    algorithm = '0-MIX-GRAD'               # Hybrid algorithm for best convergence
    ...
    for driver_arrival_rate in range(arrival_rate_min, arrival_rate_max + 1):
        ...
        try:
            ...
            filename = save_run_history(
                ...
                outcome_list,
                simulator.version,
                setting.dispatching_rule, directory='completed_runs/pure_rand'
            )
    ...
    print(f"\nDispatch rule: {dispatching_rule}")
    print(f"Algorithm: {algorithm}")
    print(f"Results directory: ./completed_runs/pure_rand/")
